...
?>
<div class="parametros-section ag-parameters-panel" id="parametros-plantillas-contrato">
  <div class="ag-parameters-panel__header">
    <div class="ag-parameters-panel__intro">
      <h5 class="ag-parameters-panel__title">Plantillas de contrato</h5>
      <p class="ag-parameters-panel__description text-muted mb-0 small">
        Asocia cada tipo con su archivo oficial y mantenlo actualizado desde la tabla.
      </p>
    </div>
    <div class="ag-parameters-panel__toolbar">
      <div class="btn-group ag-parameters-panel__btn-group" role="group" aria-label="Acciones de plantillas de contrato">
