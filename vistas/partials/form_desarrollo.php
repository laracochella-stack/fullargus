...
<div class="col-md-6">
  <label class="form-label ag-keep-label" for="selectDesarrolloCrear">Desarrollo</label>
...
<div class="col-md-6">
  <label class="form-label ag-keep-label" for="crearSuperficie">Superficie</label>
...
<div class="col-md-6">
  <label class="form-label ag-keep-label" for="crearTipoNombre">Plantilla del contrato</label>
