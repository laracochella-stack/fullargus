...
<div class="col-md-9">
  <label class="form-label" for="clienteNombre">Nombre completo</label>
...
<div class="col-md-3">
  <label class="form-label" for="clienteNacionalidad">Nacionalidad</label>
...
<div class="col-md-3">
  <label class="form-label" for="clienteGenero">Género</label>
...
<div class="col-md-4">
  <label class="form-label" for="clienteFechaNacimiento">Fecha de nacimiento</label>
...
<div class="col-md-4">
  <label class="form-label" for="clienteCurp">CURP</label>
...
<div class="col-md-4">
  <label class="form-label" for="clienteIdentificacion">Identificación</label>
...
<div class="col-md-4">
  <label class="form-label" for="clienteIne">INE (IDMEX)</label>
...
<div class="col-md-4">
  <label class="form-label" for="clienteEstadoCivil">Estado civil y régimen matrimonial</label>
...
<div class="col-md-4">
  <label class="form-label" for="clienteOcupacion">Ocupación</label>
...
<div class="col-md-6">
  <label class="form-label" for="clienteEmail">Correo electrónico</label>
...
<div class="col-md-9">
  <label class="form-label" for="clienteDomicilio">Domicilio</label>
...
<div class="col-md-6 mb-3">
  <label class="form-label" for="clienteBeneficiario">Beneficiario</label>
...
<div class="col-md-6 mb-3">
  <label class="form-label" for="clienteDiceSer">Dice ser</label>
