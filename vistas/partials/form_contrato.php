...
<div class="col-md-3">
  <label class="form-label" for="crearFolio">Folio</label>
...
<div class="col-md-3">
  <label class="form-label" for="crearFechaContrato">Fecha del contrato</label>
...
<div class="col-md-3">
  <label class="form-label" for="crearInicioPagos">Inicio de pagos</label>
...
<div class="col-md-3">
  <label class="form-label" for="inputFraccionCrear">Fracción vendida/cedida</label>
...
<div class="col-md-12">
  <label class="form-label" for="crearHabitacional">Habitacional y colindancias</label>
...
<div class="col-md-6">
  <label class="form-label" for="crearEntrega">Fecha de la posesión</label>
...
<div class="col-md-6">
  <label class="form-label" for="crearClausulaPosecion">Cláusula "C" Posesión</label>
...
<div class="col-md-6">
  <label class="form-label" for="crearFechaFirma">Fecha de firma del contrato</label>
...
<div class="col-md-3">
  <label class="form-label" for="crearMensualidades">Meses del financiamiento</label>
...
<div class="col-md-3">
  <label class="form-label" for="crearRangoPago">Años del financiamiento</label>
...
<div class="col-md-3">
  <label class="form-label" for="crearParcialidadesAnuales">Parcialidades anuales</label>
...
<div class="col-md-3">
  <label class="form-label" for="crearMontoInmueble">Monto del precio del inmueble</label>
...
<div class="col-md-3">
  <label class="form-label" for="crearEnganche">Enganche o pago inicial</label>
  <div class="input-group input-group-sm">
    <span class="input-group-text">$</span>
...
<div class="col-md-3">
  <label class="form-label" for="crearSaldoPago">Saldo de pago</label>
  <div class="input-group input-group-sm">
    <span class="input-group-text">$</span>
...
<div class="col-md-3">
  <label class="form-label" for="crearPagoMensual">Pago mensual</label>
  <div class="input-group input-group-sm">
    <span class="input-group-text">$</span>
...
<div class="col-md-3">
  <label class="form-label" for="crearPenalizacion">Penalización 20%</label>
  <div class="input-group input-group-sm">
    <span class="input-group-text">$</span>
...
<div class="col-md-6">
  <label class="form-label" for="crearObservaciones">Observaciones</label>
